...
class UserInfo {
  ...
  factory UserInfo.fromMap(Map<String?, dynamic> map) {
    ...
    return UserInfo(
      ...
      major: _asString(map['major']),
      birthday: _asString(map['birthday']),
      entrance: _asString(map['entrance']),
      hometown: _asString(map['hometown']),
      memo: _asString(map['memo']),
      deptId: _asString(map['deptId']),
      deptName: _asString(map['deptName']),
      createTime: _asString(map['createTime']),
      updateTime: _asString(map['updateTime']),
