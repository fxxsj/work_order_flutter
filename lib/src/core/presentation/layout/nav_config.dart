...
const List<String> branchOrder = [
  ...
  'die_products',
  'foiling',
  'foiling_plate_products',
  'embossing',
  'embossing_plate_products',
  'purchase_orders',
...
const List<NavItem> navItems = [
  ...
  NavItem(
    ...
    children: [
      NavItem(id: 'approval_center', label: '审批中心', icon: Icons.task_alt_outlined, path: '/approvals/center'),
      NavItem(
