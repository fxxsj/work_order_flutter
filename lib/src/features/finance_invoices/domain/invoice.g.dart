...
_$InvoiceImpl _$$InvoiceImplFromJson(Map<String, dynamic> json) =>
    _$InvoiceImpl(
      ...
      invoiceNumber:
          _stringOrNullFromJson(_readInvoiceNumber(json, 'invoice_number')),
      ...
      paymentReceivedAmount:
          _doubleOrNullFromJson(json['payment_received_amount']),
      paymentRemainingAmount:
          _doubleOrNullFromJson(json['payment_remaining_amount']),
