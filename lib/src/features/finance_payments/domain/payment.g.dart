...
_Payment _$PaymentFromJson(Map<String, dynamic> json) => _Payment(
  ...
  paymentNumber: _stringOrNullFromJson(
    _readPaymentNumber(json, 'payment_number'),
  ),
  ...
  paymentMethodDisplay: _stringOrNullFromJson(json['payment_method_display']),
  ...
  paymentDate: _dateTimeOrNullFromJson(_readPaymentDate(json, 'payment_date')),
);
