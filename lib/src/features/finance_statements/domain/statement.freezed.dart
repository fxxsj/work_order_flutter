...
@override@JsonKey(name: 'period_start', readValue: _readPeriodStart, fromJson: _dateTimeOrNullFromJson) final  DateTime? periodStart;
@override@JsonKey(name: 'period_end', readValue: _readPeriodEnd, fromJson: _dateTimeOrNullFromJson) final  DateTime? periodEnd;
@override@JsonKey(name: 'total_amount', readValue: _readTotalAmount, fromJson: _doubleOrNullFromJson) final  double? totalAmount;
@override@JsonKey(name: 'debit_amount', readValue: _readDebitAmount, fromJson: _doubleOrNullFromJson) final  double? debitAmount;
@override@JsonKey(name: 'credit_amount', readValue: _readCreditAmount, fromJson: _doubleOrNullFromJson) final  double? creditAmount;
