...
class PurchaseReceiveRecordRepositoryImpl implements PurchaseReceiveRecordRepository {
  ...
  Future<PageData<Map<String, dynamic>>> getReceiveRecords({
    ...
    return _apiService.fetchReceiveRecords(page: page, pageSize: pageSize, params: params);
  }
