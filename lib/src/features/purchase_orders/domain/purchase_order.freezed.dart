...
@JsonKey(fromJson: _intFromJson) int get id;@JsonKey(name: 'order_number', fromJson: _stringFromJson) String get orderNumber;@JsonKey(name: 'supplier_name', fromJson: _stringOrNullFromJson) String? get supplierName;@JsonKey(name: 'supplier_code', fromJson: _stringOrNullFromJson) String? get supplierCode;@JsonKey(fromJson: _stringOrNullFromJson) String? get status;@JsonKey(name: 'status_display', fromJson: _stringOrNullFromJson) String? get statusDisplay;@JsonKey(name: 'approval_status', fromJson: _stringOrNullFromJson) String? get approvalStatus;@JsonKey(name: 'approval_status_display', fromJson: _stringOrNullFromJson) String? get approvalStatusDisplay;@JsonKey(name: 'total_amount', fromJson: _doubleOrNullFromJson) double? get totalAmount;@JsonKey(name: 'items_count', fromJson: _intOrNullFromJson) int? get itemsCount;@JsonKey(name: 'received_progress', fromJson: _doubleOrNullFromJson) double? get receivedProgress;@JsonKey(name: 'work_order_number', fromJson: _stringOrNullFromJson) String? get workOrderNumber;@JsonKey(name: 'ordered_date', fromJson: _dateTimeOrNullFromJson) DateTime? get orderedDate;@JsonKey(name: 'expected_date', fromJson: _dateTimeOrNullFromJson) DateTime? get expectedDate;@JsonKey(name: 'actual_received_date', fromJson: _dateTimeOrNullFromJson) DateTime? get actualReceivedDate;@JsonKey(name: 'submitted_by_name', fromJson: _stringOrNullFromJson) String? get submittedByName;@JsonKey(name: 'approved_by_name', fromJson: _stringOrNullFromJson) String? get approvedByName;@JsonKey(name: 'created_at', fromJson: _dateTimeOrNullFromJson) DateTime? get createdAt;@JsonKey(name: 'submitted_at', fromJson: _dateTimeOrNullFromJson) DateTime? get submittedAt;@JsonKey(name: 'approved_at', fromJson: _dateTimeOrNullFromJson) DateTime? get approvedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,orderNumber,supplierName,supplierCode,status,statusDisplay,approvalStatus,approvalStatusDisplay,totalAmount,itemsCount,receivedProgress,workOrderNumber,orderedDate,expectedDate,actualReceivedDate,submittedByName,approvedByName,createdAt,submittedAt,approvedAt]);

@override
String toString() {
  return 'PurchaseOrder(id: $id, orderNumber: $orderNumber, supplierName: $supplierName, supplierCode: $supplierCode, status: $status, statusDisplay: $statusDisplay, approvalStatus: $approvalStatus, approvalStatusDisplay: $approvalStatusDisplay, totalAmount: $totalAmount, itemsCount: $itemsCount, receivedProgress: $receivedProgress, workOrderNumber: $workOrderNumber, orderedDate: $orderedDate, expectedDate: $expectedDate, actualReceivedDate: $actualReceivedDate, submittedByName: $submittedByName, approvedByName: $approvedByName, createdAt: $createdAt, submittedAt: $submittedAt, approvedAt: $approvedAt)';
}
...
@useResult
$Res call({
@JsonKey(fromJson: _intFromJson) int id,@JsonKey(name: 'order_number', fromJson: _stringFromJson) String orderNumber,@JsonKey(name: 'supplier_name', fromJson: _stringOrNullFromJson) String? supplierName,@JsonKey(name: 'supplier_code', fromJson: _stringOrNullFromJson) String? supplierCode,@JsonKey(fromJson: _stringOrNullFromJson) String? status,@JsonKey(name: 'status_display', fromJson: _stringOrNullFromJson) String? statusDisplay,@JsonKey(name: 'approval_status', fromJson: _stringOrNullFromJson) String? approvalStatus,@JsonKey(name: 'approval_status_display', fromJson: _stringOrNullFromJson) String? approvalStatusDisplay,@JsonKey(name: 'total_amount', fromJson: _doubleOrNullFromJson) double? totalAmount,@JsonKey(name: 'items_count', fromJson: _intOrNullFromJson) int? itemsCount,@JsonKey(name: 'received_progress', fromJson: _doubleOrNullFromJson) double? receivedProgress,@JsonKey(name: 'work_order_number', fromJson: _stringOrNullFromJson) String? workOrderNumber,@JsonKey(name: 'ordered_date', fromJson: _dateTimeOrNullFromJson) DateTime? orderedDate,@JsonKey(name: 'expected_date', fromJson: _dateTimeOrNullFromJson) DateTime? expectedDate,@JsonKey(name: 'actual_received_date', fromJson: _dateTimeOrNullFromJson) DateTime? actualReceivedDate,@JsonKey(name: 'submitted_by_name', fromJson: _stringOrNullFromJson) String? submittedByName,@JsonKey(name: 'approved_by_name', fromJson: _stringOrNullFromJson) String? approvedByName,@JsonKey(name: 'created_at', fromJson: _dateTimeOrNullFromJson) DateTime? createdAt,@JsonKey(name: 'submitted_at', fromJson: _dateTimeOrNullFromJson) DateTime? submittedAt,@JsonKey(name: 'approved_at', fromJson: _dateTimeOrNullFromJson) DateTime? approvedAt
});
...
/// Create a copy of PurchaseOrder
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? orderNumber = null,Object? supplierName = freezed,Object? supplierCode = freezed,Object? status = freezed,Object? statusDisplay = freezed,Object? approvalStatus = freezed,Object? approvalStatusDisplay = freezed,Object? totalAmount = freezed,Object? itemsCount = freezed,Object? receivedProgress = freezed,Object? workOrderNumber = freezed,Object? orderedDate = freezed,Object? expectedDate = freezed,Object? actualReceivedDate = freezed,Object? submittedByName = freezed,Object? approvedByName = freezed,Object? createdAt = freezed,Object? submittedAt = freezed,Object? approvedAt = freezed,}) {
...
as String?,orderedDate: freezed == orderedDate ? _self.orderedDate : orderedDate // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _PurchaseOrder() when $default != null:
return $default(_that.id,_that.orderNumber,_that.supplierName,_that.supplierCode,_that.status,_that.statusDisplay,_that.approvalStatus,_that.approvalStatusDisplay,_that.totalAmount,_that.itemsCount,_that.receivedProgress,_that.workOrderNumber,_that.orderedDate,_that.expectedDate,_that.actualReceivedDate,_that.submittedByName,_that.approvedByName,_that.createdAt,_that.submittedAt,_that.approvedAt);case _:
  return orElse();
...
class _PurchaseOrder implements PurchaseOrder {
  const _PurchaseOrder({@JsonKey(fromJson: _intFromJson) required this.id, @JsonKey(name: 'order_number', fromJson: _stringFromJson) required this.orderNumber, @JsonKey(name: 'supplier_name', fromJson: _stringOrNullFromJson) this.supplierName, @JsonKey(name: 'supplier_code', fromJson: _stringOrNullFromJson) this.supplierCode, @JsonKey(fromJson: _stringOrNullFromJson) this.status, @JsonKey(name: 'status_display', fromJson: _stringOrNullFromJson) this.statusDisplay, @JsonKey(name: 'approval_status', fromJson: _stringOrNullFromJson) this.approvalStatus, @JsonKey(name: 'approval_status_display', fromJson: _stringOrNullFromJson) this.approvalStatusDisplay, @JsonKey(name: 'total_amount', fromJson: _doubleOrNullFromJson) this.totalAmount, @JsonKey(name: 'items_count', fromJson: _intOrNullFromJson) this.itemsCount, @JsonKey(name: 'received_progress', fromJson: _doubleOrNullFromJson) this.receivedProgress, @JsonKey(name: 'work_order_number', fromJson: _stringOrNullFromJson) this.workOrderNumber, @JsonKey(name: 'ordered_date', fromJson: _dateTimeOrNullFromJson) this.orderedDate, @JsonKey(name: 'expected_date', fromJson: _dateTimeOrNullFromJson) this.expectedDate, @JsonKey(name: 'actual_received_date', fromJson: _dateTimeOrNullFromJson) this.actualReceivedDate, @JsonKey(name: 'submitted_by_name', fromJson: _stringOrNullFromJson) this.submittedByName, @JsonKey(name: 'approved_by_name', fromJson: _stringOrNullFromJson) this.approvedByName, @JsonKey(name: 'created_at', fromJson: _dateTimeOrNullFromJson) this.createdAt, @JsonKey(name: 'submitted_at', fromJson: _dateTimeOrNullFromJson) this.submittedAt, @JsonKey(name: 'approved_at', fromJson: _dateTimeOrNullFromJson) this.approvedAt});
