...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,orderNumber,supplierName,supplierCode,status,statusDisplay,totalAmount,itemsCount,receivedProgress,workOrderNumber,orderedDate,expectedDate,actualReceivedDate,submittedByName,approvedByName,createdAt,submittedAt,approvedAt);

@override
String toString() {
  return 'PurchaseOrder(id: $id, orderNumber: $orderNumber, supplierName: $supplierName, supplierCode: $supplierCode, status: $status, statusDisplay: $statusDisplay, totalAmount: $totalAmount, itemsCount: $itemsCount, receivedProgress: $receivedProgress, workOrderNumber: $workOrderNumber, orderedDate: $orderedDate, expectedDate: $expectedDate, actualReceivedDate: $actualReceivedDate, submittedByName: $submittedByName, approvedByName: $approvedByName, createdAt: $createdAt, submittedAt: $submittedAt, approvedAt: $approvedAt)';
}
...
switch (_that) {
case _PurchaseOrder() when $default != null:
return $default(_that.id,_that.orderNumber,_that.supplierName,_that.supplierCode,_that.status,_that.statusDisplay,_that.totalAmount,_that.itemsCount,_that.receivedProgress,_that.workOrderNumber,_that.orderedDate,_that.expectedDate,_that.actualReceivedDate,_that.submittedByName,_that.approvedByName,_that.createdAt,_that.submittedAt,_that.approvedAt);case _:
  return orElse();
