...
/// Create a copy of PurchaseOrderDetail
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? orderNumber = null,Object? supplierId = freezed,Object? supplierName = freezed,Object? supplierContact = freezed,Object? supplierPhone = freezed,Object? status = freezed,Object? statusDisplay = freezed,Object? totalAmount = freezed,Object? submittedByName = freezed,Object? submittedAt = freezed,Object? approvedByName = freezed,Object? approvedAt = freezed,Object? workOrderId = freezed,Object? workOrderNumber = freezed,Object? expectedDate = freezed,Object? orderedDate = freezed,Object? actualReceivedDate = freezed,Object? notes = freezed,Object? rejectionReason = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,Object? items = null,}) {
...
switch (_that) {
case _PurchaseOrderDetail() when $default != null:
return $default(_that.id,_that.orderNumber,_that.supplierId,_that.supplierName,_that.supplierContact,_that.supplierPhone,_that.status,_that.statusDisplay,_that.totalAmount,_that.submittedByName,_that.submittedAt,_that.approvedByName,_that.approvedAt,_that.workOrderId,_that.workOrderNumber,_that.expectedDate,_that.orderedDate,_that.actualReceivedDate,_that.notes,_that.rejectionReason,_that.createdAt,_that.updatedAt,_that.items);case _:
  return orElse();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,materialId,materialName,materialCode,materialUnit,supplierCode,quantity,receivedQuantity,remainingQuantity,unitPrice,subtotal,status,statusDisplay,notes,workOrderMaterialId);
...
/// Create a copy of PurchaseOrderItemDetail
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? materialId = freezed,Object? materialName = freezed,Object? materialCode = freezed,Object? materialUnit = freezed,Object? supplierCode = freezed,Object? quantity = freezed,Object? receivedQuantity = freezed,Object? remainingQuantity = freezed,Object? unitPrice = freezed,Object? subtotal = freezed,Object? status = freezed,Object? statusDisplay = freezed,Object? notes = freezed,Object? workOrderMaterialId = freezed,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(fromJson: _intFromJson)  int id, @JsonKey(name: 'material', fromJson: _intOrNullFromJson)  int? materialId, @JsonKey(name: 'material_name', fromJson: _stringOrNullFromJson)  String? materialName, @JsonKey(name: 'material_code', fromJson: _stringOrNullFromJson)  String? materialCode, @JsonKey(name: 'material_unit', readValue: _readMaterialUnit, fromJson: _stringOrNullFromJson)  String? materialUnit, @JsonKey(name: 'supplier_code', fromJson: _stringOrNullFromJson)  String? supplierCode, @JsonKey(fromJson: _doubleOrNullFromJson)  double? quantity, @JsonKey(name: 'received_quantity', fromJson: _doubleOrNullFromJson)  double? receivedQuantity, @JsonKey(name: 'remaining_quantity', fromJson: _doubleOrNullFromJson)  double? remainingQuantity, @JsonKey(name: 'unit_price', fromJson: _doubleOrNullFromJson)  double? unitPrice, @JsonKey(name: 'subtotal', fromJson: _doubleOrNullFromJson)  double? subtotal, @JsonKey(fromJson: _stringOrNullFromJson)  String? status, @JsonKey(name: 'status_display', fromJson: _stringOrNullFromJson)  String? statusDisplay, @JsonKey(fromJson: _stringOrNullFromJson)  String? notes, @JsonKey(name: 'work_order_material', fromJson: _intOrNullFromJson)  int? workOrderMaterialId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PurchaseOrderItemDetail() when $default != null:
return $default(_that.id,_that.materialId,_that.materialName,_that.materialCode,_that.materialUnit,_that.supplierCode,_that.quantity,_that.receivedQuantity,_that.remainingQuantity,_that.unitPrice,_that.subtotal,_that.status,_that.statusDisplay,_that.notes,_that.workOrderMaterialId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(fromJson: _intFromJson)  int id, @JsonKey(name: 'material', fromJson: _intOrNullFromJson)  int? materialId, @JsonKey(name: 'material_name', fromJson: _stringOrNullFromJson)  String? materialName, @JsonKey(name: 'material_code', fromJson: _stringOrNullFromJson)  String? materialCode, @JsonKey(name: 'material_unit', readValue: _readMaterialUnit, fromJson: _stringOrNullFromJson)  String? materialUnit, @JsonKey(name: 'supplier_code', fromJson: _stringOrNullFromJson)  String? supplierCode, @JsonKey(fromJson: _doubleOrNullFromJson)  double? quantity, @JsonKey(name: 'received_quantity', fromJson: _doubleOrNullFromJson)  double? receivedQuantity, @JsonKey(name: 'remaining_quantity', fromJson: _doubleOrNullFromJson)  double? remainingQuantity, @JsonKey(name: 'unit_price', fromJson: _doubleOrNullFromJson)  double? unitPrice, @JsonKey(name: 'subtotal', fromJson: _doubleOrNullFromJson)  double? subtotal, @JsonKey(fromJson: _stringOrNullFromJson)  String? status, @JsonKey(name: 'status_display', fromJson: _stringOrNullFromJson)  String? statusDisplay, @JsonKey(fromJson: _stringOrNullFromJson)  String? notes, @JsonKey(name: 'work_order_material', fromJson: _intOrNullFromJson)  int? workOrderMaterialId)  $default,) {final _that = this;
switch (_that) {
case _PurchaseOrderItemDetail():
return $default(_that.id,_that.materialId,_that.materialName,_that.materialCode,_that.materialUnit,_that.supplierCode,_that.quantity,_that.receivedQuantity,_that.remainingQuantity,_that.unitPrice,_that.subtotal,_that.status,_that.statusDisplay,_that.notes,_that.workOrderMaterialId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(fromJson: _intFromJson)  int id, @JsonKey(name: 'material', fromJson: _intOrNullFromJson)  int? materialId, @JsonKey(name: 'material_name', fromJson: _stringOrNullFromJson)  String? materialName, @JsonKey(name: 'material_code', fromJson: _stringOrNullFromJson)  String? materialCode, @JsonKey(name: 'material_unit', readValue: _readMaterialUnit, fromJson: _stringOrNullFromJson)  String? materialUnit, @JsonKey(name: 'supplier_code', fromJson: _stringOrNullFromJson)  String? supplierCode, @JsonKey(fromJson: _doubleOrNullFromJson)  double? quantity, @JsonKey(name: 'received_quantity', fromJson: _doubleOrNullFromJson)  double? receivedQuantity, @JsonKey(name: 'remaining_quantity', fromJson: _doubleOrNullFromJson)  double? remainingQuantity, @JsonKey(name: 'unit_price', fromJson: _doubleOrNullFromJson)  double? unitPrice, @JsonKey(name: 'subtotal', fromJson: _doubleOrNullFromJson)  double? subtotal, @JsonKey(fromJson: _stringOrNullFromJson)  String? status, @JsonKey(name: 'status_display', fromJson: _stringOrNullFromJson)  String? statusDisplay, @JsonKey(fromJson: _stringOrNullFromJson)  String? notes, @JsonKey(name: 'work_order_material', fromJson: _intOrNullFromJson)  int? workOrderMaterialId)?  $default,) {final _that = this;
switch (_that) {
case _PurchaseOrderItemDetail() when $default != null:
return $default(_that.id,_that.materialId,_that.materialName,_that.materialCode,_that.materialUnit,_that.supplierCode,_that.quantity,_that.receivedQuantity,_that.remainingQuantity,_that.unitPrice,_that.subtotal,_that.status,_that.statusDisplay,_that.notes,_that.workOrderMaterialId);case _:
  return null;
