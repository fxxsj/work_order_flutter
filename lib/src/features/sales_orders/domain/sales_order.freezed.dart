...
@JsonKey(fromJson: _intFromJson) int get id;@JsonKey(name: 'order_number', fromJson: _stringFromJson) String get orderNumber;@JsonKey(name: 'customer_name', fromJson: _stringOrNullFromJson) String? get customerName;@JsonKey(name: 'customer_code', fromJson: _stringOrNullFromJson) String? get customerCode;@JsonKey(fromJson: _stringOrNullFromJson) String? get status;@JsonKey(name: 'status_display', fromJson: _stringOrNullFromJson) String? get statusDisplay;@JsonKey(name: 'approval_status', fromJson: _stringOrNullFromJson) String? get approvalStatus;@JsonKey(name: 'approval_status_display', fromJson: _stringOrNullFromJson) String? get approvalStatusDisplay;@JsonKey(name: 'payment_status', fromJson: _stringOrNullFromJson) String? get paymentStatus;@JsonKey(name: 'payment_status_display', fromJson: _stringOrNullFromJson) String? get paymentStatusDisplay;@JsonKey(name: 'total_amount', fromJson: _doubleOrNullFromJson) double? get totalAmount;@JsonKey(name: 'order_date', fromJson: _dateTimeOrNullFromJson) DateTime? get orderDate;@JsonKey(name: 'delivery_date', fromJson: _dateTimeOrNullFromJson) DateTime? get deliveryDate;@JsonKey(name: 'items_count', fromJson: _intOrNullFromJson) int? get itemsCount;@JsonKey(name: 'work_order_count', fromJson: _intOrNullFromJson) int? get workOrderCount;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,orderNumber,customerName,customerCode,status,statusDisplay,approvalStatus,approvalStatusDisplay,paymentStatus,paymentStatusDisplay,totalAmount,orderDate,deliveryDate,itemsCount,workOrderCount);

@override
String toString() {
  return 'SalesOrder(id: $id, orderNumber: $orderNumber, customerName: $customerName, customerCode: $customerCode, status: $status, statusDisplay: $statusDisplay, approvalStatus: $approvalStatus, approvalStatusDisplay: $approvalStatusDisplay, paymentStatus: $paymentStatus, paymentStatusDisplay: $paymentStatusDisplay, totalAmount: $totalAmount, orderDate: $orderDate, deliveryDate: $deliveryDate, itemsCount: $itemsCount, workOrderCount: $workOrderCount)';
}
...
@useResult
$Res call({
@JsonKey(fromJson: _intFromJson) int id,@JsonKey(name: 'order_number', fromJson: _stringFromJson) String orderNumber,@JsonKey(name: 'customer_name', fromJson: _stringOrNullFromJson) String? customerName,@JsonKey(name: 'customer_code', fromJson: _stringOrNullFromJson) String? customerCode,@JsonKey(fromJson: _stringOrNullFromJson) String? status,@JsonKey(name: 'status_display', fromJson: _stringOrNullFromJson) String? statusDisplay,@JsonKey(name: 'approval_status', fromJson: _stringOrNullFromJson) String? approvalStatus,@JsonKey(name: 'approval_status_display', fromJson: _stringOrNullFromJson) String? approvalStatusDisplay,@JsonKey(name: 'payment_status', fromJson: _stringOrNullFromJson) String? paymentStatus,@JsonKey(name: 'payment_status_display', fromJson: _stringOrNullFromJson) String? paymentStatusDisplay,@JsonKey(name: 'total_amount', fromJson: _doubleOrNullFromJson) double? totalAmount,@JsonKey(name: 'order_date', fromJson: _dateTimeOrNullFromJson) DateTime? orderDate,@JsonKey(name: 'delivery_date', fromJson: _dateTimeOrNullFromJson) DateTime? deliveryDate,@JsonKey(name: 'items_count', fromJson: _intOrNullFromJson) int? itemsCount,@JsonKey(name: 'work_order_count', fromJson: _intOrNullFromJson) int? workOrderCount
});
...
/// Create a copy of SalesOrder
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? orderNumber = null,Object? customerName = freezed,Object? customerCode = freezed,Object? status = freezed,Object? statusDisplay = freezed,Object? approvalStatus = freezed,Object? approvalStatusDisplay = freezed,Object? paymentStatus = freezed,Object? paymentStatusDisplay = freezed,Object? totalAmount = freezed,Object? orderDate = freezed,Object? deliveryDate = freezed,Object? itemsCount = freezed,Object? workOrderCount = freezed,}) {
...
switch (_that) {
case _SalesOrder() when $default != null:
return $default(_that.id,_that.orderNumber,_that.customerName,_that.customerCode,_that.status,_that.statusDisplay,_that.approvalStatus,_that.approvalStatusDisplay,_that.paymentStatus,_that.paymentStatusDisplay,_that.totalAmount,_that.orderDate,_that.deliveryDate,_that.itemsCount,_that.workOrderCount);case _:
  return orElse();
...
/// Create a copy of SalesOrder
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? orderNumber = null,Object? customerName = freezed,Object? customerCode = freezed,Object? status = freezed,Object? statusDisplay = freezed,Object? approvalStatus = freezed,Object? approvalStatusDisplay = freezed,Object? paymentStatus = freezed,Object? paymentStatusDisplay = freezed,Object? totalAmount = freezed,Object? orderDate = freezed,Object? deliveryDate = freezed,Object? itemsCount = freezed,Object? workOrderCount = freezed,}) {
