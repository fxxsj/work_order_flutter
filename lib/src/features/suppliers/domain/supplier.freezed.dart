    ...
    return _then(_value.copyWith(
      ...
      statusDisplay: freezed == statusDisplay
          ...
          : statusDisplay // ignore: cast_nullable_to_non_nullable
              as String?,
      materialCount: freezed == materialCount
...
class _$SupplierImpl implements _Supplier {
  const _$SupplierImpl(
      ...
      @JsonKey(fromJson: _stringOrNullFromJson) this.code,
      @JsonKey(name: 'contact_person', fromJson: _stringOrNullFromJson)
      this.contactPerson,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, code, contactPerson,
      phone, email, address, status, statusDisplay, materialCount, notes);
...
abstract class _Supplier implements Supplier {
  const factory _Supplier(
          ...
          @JsonKey(fromJson: _stringOrNullFromJson) final String? code,
          @JsonKey(name: 'contact_person', fromJson: _stringOrNullFromJson)
          final String? contactPerson,
